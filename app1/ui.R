    ...
    dashboardBody(
        tabItems(
            ...
            tabItem(tabName = "sd",
                    fluidPage(
                        fluidRow(
                            column( width = 12,h4("Brooklyn Covid-19 cases and Park gatherings ", align = 'center'), highchartOutput('BKdistPlot')
                            )  
                        ),
                        fluidRow(
                            column( width = 12,h4("Bronx Covid-19 cases and Park gatherings ", align = 'center'), highchartOutput('BXdistPlot') )
                            
                        ),
                        fluidRow(
                            column( width = 12,h4("Manhattan Covid-19 cases and Park gatherings ", align = 'center'), highchartOutput('MNdistPlot') )
                            
                        ),
                        fluidRow(
                            column( width = 12,h4("Queens Covid-19 cases and Park gatherings  ", align = 'center'), highchartOutput('QNdistPlot') )
                            
                        ),
                        fluidRow(
                            column( width = 12,h4("StatenIsland Covid-19 cases and Park gatherings  ", align = 'center'), highchartOutput('SIdistPlot') )
